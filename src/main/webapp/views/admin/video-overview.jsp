							...
							<tbody>
								<c:forEach items="${videos}" var="item">
									<tr>
										...
										<td><img alt="" src="${item.poster}" width="250px"
											height="150px"></td>
										<td>
											<a href="<c:url value='/admin/video?action=edit&href=${item.href}'/>" type="button" class="btn btn-block btn-success btn-sm">Edit</a>
											<button type="button" onclick="videoDelete('${item.href}')" class="btn btn-block btn-danger btn-sm">Delete</button>
										</td>
