    ...
    $('#changePass').click(function () {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#messageChange').text('Password changed successfully >.<'); // Changed id to match the id in the HTML
                
            },
            error: function (xhr, status, error) {
                $('#messageChange').text('Incorrect password, please try again'); // Changed id to match the id in the HTML
            }
        });
    }); 
</script>
